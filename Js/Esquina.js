function Esquina(a, b) {
  ...
  this.findEnds = function(esquina) {
    this.h1.findEnd(esquina.h1);
    this.h1.findEnd(esquina.h2);
    this.h2.findEnd(esquina.h1);
    this.h2.findEnd(esquina.h2);
  }
}
